...
//    objectVector.push_back(std::make_shared<Sphere>(sphere1));
    ...
    Cube sphere2(tSphere2, {0, 0, 1, 0}, 0.2, 0.8, 0);
    objectVector.push_back(std::make_shared<Cube>(sphere2));

    Transformation tSphere3;
    tSphere3.addScaling(200, 200, 200);
    tSphere3.addTranslation(2000, 0, 0);
    Cube sphere3(tSphere3, {1, 0, 0, 0}, 0.2, 0.8, 0);
    objectVector.push_back(std::make_shared<Cube>(sphere3));
...
//    objectVector.push_back(std::make_shared<Plane>(plane1));
    ...
    // LIGHT
    LightSource light({0,1000,0,1}, {2000,-1000,0,0}, 1);
